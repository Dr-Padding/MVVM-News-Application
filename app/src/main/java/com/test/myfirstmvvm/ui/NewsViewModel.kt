...
import com.test.myfirstmvvm.NewsApplication
import com.test.myfirstmvvm.models.Article
import com.test.myfirstmvvm.models.NewsResponse
    ...
    private suspend fun safeBreakingNewsCall(countryCode: String){
        ...
        try {
            if(hasInternetConnection()){
                ...
                breakingNews.postValue(Resource.Error("Please, check your Internet connection and restart the app"))
            }
        } catch (t: Throwable){
            when(t) {
